var subjects = [
  {
    ...
    parties: [
      ...
      },
      {
        ...
        position: "pro",
        opinion:
          "Burgers moeten meer inspraak krijgen bij politieke besluitvorming. Wij zijn voor een bindend referendum zodat de regering de uitslag niet naast zich neer kan leggen, zoals gebeurde bij het referendum over de Europese Grondwet in 2005 en het OekraÃ¯ne-referendum van vorig jaar. "
      },
      {
        name: "Nieuwe Wegen",
        position: "pro",
      ...
      },
      {
        ...
        position: "pro",
        opinion:
          "Dit is de enige manier om politici te dwingen om naar de bevolking te luisteren. Niet-bindende referenda worden niet serieus genomen, zie referenda over EU Grondwet en Associatieverdrag OekraÃ¯ne."
      },
      {
      ...
      },
      {
        ...
        position: "contra",
        opinion:
          "De ChristenUnie is tegen een referendum, de bevolking kiest al rechtstreeks haar vertegenwoordigers. Dat is de â€˜representatieve democratieâ€™ waar de ChristenUnie voor staat. Wel komt er, om onze vrijheidsrechten uit de grondwet te beschermen een Constitutioneel Hof dat wetten toetst aan de Grondwet."
      },
      {
        name: "SGP",
        position: "contra",
  ...
  },
  {
    ...
    parties: [
      ...
      },
      {
        ...
        position: "contra",
        opinion:
          "Natuurlijk is het mooi als jongeren zich willen inzetten voor de maatschappij, maar dat is het juist als zij er zÃ©lf voor kiezen. Daarom wil D66 dit niet verplicht stellen. Scholen kunnen kiezen voor het aanbieden van een maatschappelijke stage, maar dat moet niet door de overheid worden opgelegd."
      },
      {
        name: "GroenLinks",
        position: "contra",
      ...
      },
      {
        ...
        position: "contra",
        opinion:
          "Dit zorgt voor verdringing van reguliere banen, en is in strijd met het gelijkwaardigheidsprincipe : â€œgelijk loon voor gelijk werkâ€,  zoals vastgelegd in de Universele Verklaring voor de Rechten van de Mens. Liever zien wij sociaal-maatschappelijk bewustzijn als structureel onderdeel van het onderwijs."
      },
      {
        name: "Libertarische Partij",
        position: "contra",
    ...
    parties: [
      {
        ...
        position: "pro",
        opinion:
          "Het zou eigenlijk niet nodig moeten zijn dat mensen hun leeftijd, naam of geslacht achterwege houden. Maar zolang deze vorm van discriminatie een feit is moeten we die aanpakken Ã©n mensen de kans geven om uitgenodigd te worden voor een sollicitatiegesprek. Anoniem solliciteren biedt dat perspectief. "
      },
      {
        name: "D66",
        position: "pro",
        opinion:
          "Nederlanders met een niet-westerse achtergrond zijn drie keer vaker werkloos dan Nederlanders met een westerse achtergrond. D66 wil dit verschil terugdringen. EÃ©n van de maatregelen die D66 wil nemen is het opzetten van experimenten met neutrale sollicitatie- en promotieprocedures."
      },
      {
        name: "GroenLinks",
        position: "pro",
      ...
      },
      {
        ...
        position: "pro",
        opinion:
          "50PLUS vindt dat alle vormen van discriminatie hoog op de agenda moeten staan. Discriminatie op de arbeidsmarkt - op welke grond dan ook - moet teruggedrongen worden. Anoniem solliciteren kan daarbij helpen; solliciteren zonder vermelding van de leeftijd bijvoorbeeld Ã³Ã³k. "
      },
      {
        name: "Lokaal in de Kamer",
        position: "pro",
  ...
  },
  {
    ...
    parties: [
      ...
      },
      {
        ...
        position: "none",
        opinion:
          "De Piratenpartij is tegen het strafbaarstellen van beledigingen. Discriminatie (een beoordeling op basis van ras, godsdienst of geaardheid) moet echter wÃ©l strafbaar blijven. De Piratenpartij wil niet tornen aan het recht op gelijke behandeling."
      },
      {
        name: "Niet Stemmers",
        position: "none",
      ...
      },
      {
        ...
        position: "contra",
        opinion:
          "De Partij voor de Dieren vindt dat de overheid met kracht moet optreden tegen alle uitingsvormen van discriminatie. Het is mede de taak van de overheid om overal waar sprake is\r\nvan achterstelling van groepen - zoals mensen met een beperking, vrouwen, etnische minderheden en LHBTI- zorg te dragen voor volwaardige integratie en gelijkberechtiging.\r\n"
      },
      {
        name: "50Plus",
        position: "contra",
  ...
  },
  {
    ...
    parties: [
      ...
      },
      {
        ...
        position: "pro",
        opinion:
          "Het gebruik en de productie van softdrugs wordt gelegaliseerd, zodat teelt legaal wordt en er accijns over kan worden geheven. De overheid draagt zorg voor een goede voorlichting over de gezondheidsrisicoâ€™s van het gebruik van softdrugs."
      },
      {
        name: "50Plus",
        position: "pro",
      ...
      },
      {
        ...
        position: "pro",
        opinion:
          "De politie moet zich bezighouden met de bestrijding van echte criminaliteit. Wiet is niet schadelijker dan alcohol en tabak. Harddrugs (bijvoorbeeld heroÃ¯ne) pakken we keihard aan. "
      },
      {
        name: "DENK",
        position: "pro",
      ...
      },
      {
        ...
        position: "contra",
        opinion:
          "De SGP vindt het gedoogbeleid onduidelijk en halfslachtig. De indruk wordt gewekt dat zoâ€™n beetje alles kan of door de vingers wordt gezien. Het gedoogbeleid moet daarom per direct worden afgeschaft. In plaats van gedogen wil de SGP de wet handhaven. De productie van drugs blijft dan ook strafbaar als het aan de SGP ligt. Aan gereguleerde wietteelt van de overheid moeten we niet beginnen."
      }
    ]
  },
  {
    ...
    parties: [
      {
        ...
        position: "pro",
        opinion:
          "Die kleine groep mensen in Nederland die meer dan â‚¬150.000 per jaar verdient, vragen we een extra bijdrage te leveren. Dat geld wil de PvdA gebruiken voor betere ouderenzorg."
      },
      {
        name: "SP",
        position: "pro",
      ...
      },
      {
        ...
        position: "pro",
        opinion:
          "De Partij voor de Dieren vindt dat de sterkste schouders de zwaarste lasten moeten dragen. Echter zeker zo belangrijk is een beter belastingstelsel, waarin het gebruik van grondstoffen meer belast wordt en arbeid wordt verlaagd. Zo creÃ«ren we werkgelegenheid en maken we de samenleving duurzamer."
      },
      {
        name: "DENK",
        position: "pro",
      ...
      },
      {
        ...
        position: "contra",
        opinion:
          "De SGP wil dat de lasten op arbeid worden verlaagd door het introduceren van Ã©Ã©n laag, uniform basistarief en een toptarief: de zogenoemde sociale vlaktaks. De hoogste inkomensgroepen moeten daarbij zeker niet nog meer belasting gaan betalen dan ze nu al doen.\r\n"
      },
      {
        name: "OndernemersPartij",
        position: "contra",
      ...
      },
      {
        ...
        position: "contra",
        opinion:
          "De belastingen moeten over de hele linie omlaag, vooral voor de minst verdienenden door invoering van een belastingvrije voet van â‚¬20.000 voor iedereen. De economische dynamiek moet terug in Nederland."
      },
      {
        name: "Piratenpartij",
        position: "contra",
        opinion:
          "De Piratenpartij wil het belastingstelsel zo hervormen, dat reÃ«le productie gestimuleerd wordt. Wij willen multinationals aanpakken en het verbruik van grondstoffen meer belasten."
      },
      {
        name: "Libertarische Partij",
        position: "contra",
        opinion:
          "De hoogste inkomensgroepen betalen al het leeuwendeel van de opbrengsten van de inkomstenbelasting. Belasting moet juist voor alle inkomensgroepen omlaag. De LP pleit voor een belastingvrije voet van â‚¬20.000 voor alle werknemers en daarna een vlaktaks van 15,6%.\r\n"
      },
      {
        name: "Lokaal in de Kamer",
        position: "contra",
  ...
  },
  {
    ...
    parties: [
      ...
      },
      {
        ...
        position: "contra",
        opinion:
          "We worden gemiddeld ouder en we willen allemaal op een gegeven moment een goede oude dag. Het kan niet anders dan dat we de AOW leeftijd moeten laten stijgen. Wie echter een leven lang hard gewerkt heeft en niet meer kÃ¡n, moet eerder kunnen stoppen. Daarom moet je zelf kunnen bepalen of je eerder stopt tegen een reÃ«le en behapbare korting op de AOW. "
      },
      {
        name: "CDA",
        position: "contra",
      ...
      },
      {
        ...
        position: "contra",
        opinion:
          "GroenLinks was en is voorstander van de verhoging van de AOW-leeftijd om de AOW op lange termijn betaalbaar te houden. er is een groep mensen in fysiek zware beroepen van wie het niet reÃ«el is om te vragen langer door te werken. Voor hen wil GroenLinks vervroegde uittreding mogelijk maken."
      },
      {
        name: "SGP",
        position: "contra",
      ...
      },
      {
        ...
        position: "contra",
        opinion:
          "FVD wil de AOW-leeftijd naar 66 jaar. En voor alle AOW-ers wil FVD ook de belastingvrije voet van â‚¬20.000 zodat het koopkrachtverlies van AOW-ers onmiddellijk wordt hersteld."
      },
      {
        name: "Vrijzinnige Partij",
        position: "contra",
  ...
  },
  {
    ...
    parties: [
      ...
      },
      {
        ...
        position: "pro",
        opinion:
          "De ChristenUnie wil dat wie werkt verzekerd is tegen arbeidsongeschiktheid. Daarom zijn wij voor een verplichte verzekering voor zzpâ€™ers voor arbeidsongeschiktheid die een minimuminkomen garandeert. Dit verkleint de risicoâ€™s voor de zzpâ€™er en zorgt voor een gelijker speelveld op de arbeidsmarkt."
      },
      {
        name: "GroenLinks",
        position: "pro",
      ...
      },
      {
        ...
        position: "pro",
        opinion:
          "50PLUS vindt het verstandig om zzpâ€™ers verplicht te stellen zich te verzekeren tegen arbeidsongeschiktheid en ook verplicht pensioen op te laten bouwen. Die verplichting moet voor iedereen gelden, zodat een gelijk speelveld ontstaat voor Ã¡lle zzpâ€™ers. Dit heeft ook het voordeel dat een meer gelijk speelveld ontstaat met werknemers in loondienst die ook deze verplichte verzekerings-en pensioenkosten hebben. Hiermee kan de kloof tussen vast,  tijdelijk en flexibel werk enigszins geslecht worden."
      },
      {
        name: "DENK",
        position: "pro",
      ...
      },
      {
        ...
        position: "pro",
        opinion:
          "Deze groep mensen blijft nu deels verstoken van sociale zekerheid. Een collectieve verplichte verzekering is betaalbaarder en eerlijker dan stimuleren van verplichte privÃ©verzekeringen."
      },
      {
        name: "Lokaal in de Kamer",
        position: "pro",
      ...
      },
      {
        ...
        position: "contra",
        opinion:
          "Als je bewust kiest voor zelfstandigheid, moet je natuurlijk zo veel mogelijk ruimte krijgen.  Want met minimale verplichtingen heb je maximale ruimte om te ondernemen. Als ZZPâ€™er moet je daarom zelf kunnen bepalen waarvoor en hoe je je wilt verzekeren."
      },
      {
        name: "PVV",
        position: "contra",
      ...
      },
      {
        ...
        position: "contra",
        opinion:
          "Het wordt voor zzpâ€™ers eenvoudiger om vrijwillig te sparen voor pensioen of zich te verzekeren. Zzpâ€™ers krijgen toegang tot een publieke arbeidsongeschiktheids- en pensioenverzekering. Zoâ€™n verzekering mag echter geen verplichtend karakter hebben."
      },
      {
        name: "OndernemersPartij",
        position: "contra",
        opinion:
          "De keuze behoort bij ZZPÂ´ers zelf te liggen. De overheid zou zelf een sociaal ondervang moeten regelen voor de ZZPÂ´ers."
      },
      {
        name: "VNL",
        position: "contra",
    ...
    parties: [
      {
        ...
        position: "pro",
        opinion:
          "Het schuldenstelsel dat vorig jaar voor studenten is ingevoerd zorgt ervoor dat jongere generaties met grote schulden hun loopbaan beginnen. Onderwijs is te belangrijk voor ons land om met financiÃ«le drempels te beperken en ontmoedigen. Wij moeten jongeren stimuleren, niet straffen, om door te leren. "
      },
      {
        name: "CDA",
        position: "pro",
      ...
      },
      {
        ...
        position: "pro",
        opinion:
          "De ChristenUnie voert de basisbeurs weer in en zet een streep door het leenstelsel. Het leenstelsel is een te hoge financiÃ«le drempel tot hoger onderwijs en leidt tot kansenongelijkheid. Het is ook onwenselijk dat jonge mensen na hun studie met grote schulden de arbeidsmarkt en woningmarkt betreden."
      },
      {
        name: "Partij voor de Dieren",
        position: "pro",
      ...
      },
      {
        ...
        position: "pro",
        opinion:
          "Iedereen moet kunnen studeren, ongeacht de financiÃ«le situatie van de ouders."
      },
      {
        name: "De Burger Beweging",
        position: "pro",
      ...
      },
      {
        ...
        position: "pro",
        opinion:
          "De Piratenpartij vindt onderwijs een belangrijk burgerrecht, dat niet afhankelijk zou moeten zijn van je portemonnee. Door het leenstelsel zien steeds meer jongeren om financiÃ«le redenen af van onderwijs op het hoogste niveau."
      },
      {
        name: "Artikel 1",
        position: "pro",
      ...
      },
      {
        ...
        position: "pro",
        opinion:
          "Studiekeuze wordt nu mede bepaald door financiÃ«le situatie en niet door motivatie. Studeren moet weer toegankelijk zijn alle jongeren. "
      },
      {
        name: "VNL",
        position: "none",
      ...
      },
      {
        ...
        position: "contra",
        opinion:
          "De SGP vindt dat financiÃ«le drempels geen belemmering mogen zijn voor het volgen van hoger onderwijs. Vooral de (lagere) middeninkomens zitten nu in de knel. De aanvullende beurs moet daarom uitgebreid worden."
      },
      {
        name: "Libertarische Partij",
        position: "contra",
  ...
  },
  {
    ...
    parties: [
      ...
      },
      {
        ...
        position: "pro",
        opinion:
          "Kunst en cultuur zijn als de adem van de samenleving. Daar moet ruimte voor zijn. Zo stelt de Vrijzinnige Partij voor om huisvestingskosten voor culturele instellingen te subsidiÃ«ren en om tot 25 jaar iedereen gratis toegang te geven tot de musea en voor iedereen boven de 25 jaar een gratis museumjaarkaart."
      },
      {
        name: "Artikel 1",
        position: "pro",
        opinion:
          'Kunst, cultuur en wetenschap zijn belangrijke pijlers voor een beschaafde samenleving. Zij dagen ons uit en zetten aan tot groei en cohesie. Er is de afgelopen jaren teveel gesneden in de kunst- en cultuurbudgetten. Vrij naar Churchill: â€œals we niet voor kunst en cultuur vechten, waar vechten we dan voor?".'
      },
      {
        name: "DENK",
        position: "none",
      ...
      },
      {
        ...
        position: "contra",
        opinion:
          "De rijksoverheid geeft maar liefst â‚¬800 miljoen uit aan kunst en cultuur in 2017. Dat is meer dan genoeg.  "
      },
      {
        name: "PVV",
        position: "contra",
  ...
  },
  {
    ...
    parties: [
      ...
      },
      {
        ...
        position: "contra",
        opinion:
          "â€˜Echteâ€™ vluchtelingen vanuit niet veilige, in oorlog verkerende landen moeten â€“ uiteraard binnen de geldende regels, randvoorwaarden en waarborgen â€“ asiel kunnen aanvragen in Nederland, ongeacht hun geloof, levensovertuiging, of geaardheid. "
      },
      {
        name: "OndernemersPartij",
        position: "contra",
      ...
      },
      {
        ...
        position: "contra",
        opinion:
          "Oneens, Nederland moet stoppen met deelname aan oorlog (zogenaamde vredesmissies etc.) en creÃ«ren van vluchtelingen problemen."
      },
      {
        name: "Vrijzinnige Partij",
        position: "contra",
  ...
  },
  {
    ...
    parties: [
      ...
      },
      {
        ...
        position: "pro",
        opinion:
          "Wij vinden dat er ruimhartig moet worden omgegaan met kinderen van asielzoekers die hier zijn opgegroeid. Zij kennen vaak geen andere samenleving dan de Nederlandse en zijn hier geÃ¯ntegreerd. Als er wel sprake is van terugkeer moet dit zorgvuldig begeleid gebeuren."
      },
      {
        name: "D66",
        position: "pro",
      ...
      },
      {
        ...
        position: "pro",
        opinion:
          "Kinderen mogen nooit de dupe zijn van oorlogen, vreemdelingenhaat of financiÃ«le overwegingen. Kinderen verdienen een toekomst. DENK wil kinderen deze toekomst geven. "
      },
      {
        name: "De Burger Beweging",
        position: "pro",
  ...
  },
  {
    ...
    parties: [
      ...
      },
      {
        ...
        position: "pro",
        opinion:
          "Asielbeleid is rijksbeleid. Als vreemdelingen volgens de geldende regels niet (meer) in ons land mogen verblijven mogen gemeenten dit beleid niet doorkruisen, door zogenaamde â€˜illegale vreemdelingenâ€™ die volgens de regels geen recht (meer) hebben op verblijf,  onderdak te bieden. "
      },
      {
        name: "OndernemersPartij",
        position: "pro",
  ...
  },
  {
    ...
    parties: [
      ...
      },
      {
        ...
        position: "pro",
        opinion:
          "Forum voor Democratie wil voor iedereen een belastingvrije voet van â‚¬20.000 invoeren en een tweetaks van 20% en 35%. Zo lang dit niet is gerealiseerd blijft de aftrek van de hypotheekrente ongewijzigd in stand.\r\n"
      },
      {
        name: "Artikel 1",
        position: "pro",
        opinion:
          "De aanpassingen in de hypotheekrente aftrek van de afgelopen jaren hebben voldoende werking gehad. De woningmarkt komt weer op gang.\r\nVerdere aanpassingen maakt het bezit van huizen moeilijker haalbaar en houdbaar voor een grote groep Nederlanders."
      },
      {
        name: "Lokaal in de Kamer",
        position: "pro",
      ...
      },
      {
        ...
        position: "contra",
        opinion:
          "D66 wil de belasting op werken fors verlagen. Tegelijkertijd brengen we de hypotheekrenteaftrek stapsgewijs verder omlaag. Per saldo gaan huizenbezitters er op vooruit. Omdat de rente laag is, is dit hÃ©t moment om onze schulden aan te pakken. Bovendien worden koop en huur hierdoor gelijker behandeld."
      },
      {
        name: "ChristenUnie",
        position: "contra",
  ...
  },
  {
    ...
    parties: [
      ...
      },
      {
        ...
        position: "pro",
        opinion:
          "Eens, beter is om het probleem bij de bron aan te pakken en te zorgen dat de rente die woningbouwverenigingen moeten betalen te verlagen naar inflatie plus maximaal 0,5% per jaar. En de speculatieve bubbel in de grondprijzen aan te pakken.\r\nOp financieren van woningen betalen we sinds 1970 gemiddeld 3% per jaar teveel rente."
      },
      {
        name: "Vrijzinnige Partij",
        position: "pro",
      ...
      },
      {
        ...
        position: "pro",
        opinion:
          "Het geld van de verhuurdersheffing moet worden geÃ¯nvesteerd in sociale woningbouw om de woningnood in die groep op te lossen. "
      },
      {
        name: "CDA",
        position: "none",
  ...
  },
  {
    ...
    parties: [
      ...
      },
      {
        ...
        position: "contra",
        opinion:
          "De uitbreiding van Schiphol is slecht voor het klimaat en voor de gezondheid en rust van mensen die in buurt van Schiphol wonen. In plaats daarvan wil GroenLinks snellere treinverbindingen met Duitsland en BelgiÃ«. Verdere groei van Schiphol is daarom niet nodig."
      },
      {
        name: "SGP",
        position: "contra",
      ...
      },
      {
        ...
        position: "contra",
        opinion:
          "Grenzen aan groei betekent ook denken aan een betere leefomgeving voor de regio rond Schiphol. Uitbreiden gaat alleen maar uit van expansie van de luchtvaart. Grenzen aan de groei van Schiphol betekent daarom innovatie voor nieuwe mogelijkheden zoals efficiÃ«ntere vliegtuigen, hogesnelheidstreinen en verspreide regionale luchthavens."
      }
    ]
  },
  {
    ...
    parties: [
      ...
      },
      {
        ...
        position: "pro",
        opinion:
          "Volgens het principe â€œde vervuiler betaaltâ€. Per kilometer belasten stimuleert andere vormen van vervoer dan de auto. "
      },
      {
        name: "VNL",
        position: "none",
  ...
  },
  {
    ...
    parties: [
      ...
      },
      {
        ...
        position: "contra",
        opinion:
          "Nederland is een prachtig land. Daarom wil GroenLinks geen nieuwe wegen die ons land nog verder versnipperen en de lucht vervuilen. Meer asfalt leidt tot mÃ©Ã©r verkeer en mÃ©Ã©r files. De enorme bedragen die zijn gereserveerd voor wegen willen we investeren in een beter en sneller openbaar vervoer."
      },
      {
        name: "Partij voor de Dieren",
        position: "contra",
      ...
      },
      {
        ...
        position: "contra",
        opinion:
          "Nederland kent een uitstekend wegennet waarvoor geldt dat nieuwe wegen om nieuwe verbindingen te maken bijna niet nodig zijn. Verdere aantasting van onze leefomgeving moet daarom een halt worden toegeroepen.Wel kan geÃ¯nvesteerd moeten worden in de bestaande wegen om de capaciteit goed te houden en files te voorkomen. Belangrijk uitgangspunt is daarbij geen aantasting van landschap plaatsvindt. Dus tegen verbreding A27 Lunetten, tegen Blankenburgtunnel"
      },
      {
        name: "Piratenpartij",
        position: "contra",
  ...
  },
  {
    ...
    parties: [
      ...
      },
      {
        ...
        position: "contra",
        opinion:
          "Vieze energie van kolen is, alle kosten voor klimaat en maatschappij meegerekend, veel duurder dan schone energie. D66 wil daarom alle kolencentrales in Nederland zo snel mogelijk, maar uiterlijk in 2025, op verantwoorde wijze sluiten â€“ beginnend bij de meest vervuilende."
      },
      {
        name: "ChristenUnie",
        position: "contra",
        opinion:
          "De ChristenUnie zet in op een snelle en volledige energietransitie binnen Ã©Ã©n generatie. We willen snel af van de kolencentrales. Daarom komen er hogere milieunormen voor energiecentrales en stoppen we met subsidie voor biomassabijstook. Hierdoor zullen kolencentrales moeten sluiten."
      },
      {
        name: "GroenLinks",
        position: "contra",
    ...
    parties: [
      {
        ...
        position: "pro",
        opinion:
          "Te veel vlees in Nederland is afkomstig uit de bio-industrie. Dit zorgt voor veel dierenleed, draagt bij aan de ontwrichting van ons klimaat en vervuilt de natuur. GroenLinks vindt daarom dat voor vlees het hoge btw-tarief moet gelden. Met Ã©Ã©n vleesloze dag in de week kan je al het verschil maken"
      },
      {
        name: "Partij voor de Dieren",
        position: "pro",
        opinion:
          "Vleesproductie stoot wereldwijd 40% meer broeikasgassen uit dan Ã¡l het verkeer en vervoer bij elkaar.\r\nWe maken onduurzame producten zoals dierlijke producten duurder en duurzame producten goedkoper. (Biologische) groente en fruit worden vrij van btw. De belasting op arbeid gaat fors omlaag. Zo wordt mogelijk dat we duurzaam kunnen consumeren."
      },
      {
        name: "De Burger Beweging",
        position: "pro",
      ...
      },
      {
        ...
        position: "contra",
        opinion:
          "Voor voedsel blijft wat betreft de ChristenUnie het lage btw-tarief van 6% gelden, dus ook voor vlees. Boeren en tuinders verdienen een eerlijke prijs voor hun producten. Er komt, evenals in BelgiÃ« en Duitsland, een verbod op verkoop van voedsel onder de kostprijs."
      },
      {
        name: "SGP",
        position: "contra",
      ...
      },
      {
        ...
        position: "contra",
        opinion:
          "DENK wil de rekening van de bio-industrie niet leggen bij de consument, maar bij de bio-industrie. Wij willen meer voorlichting over vlees en meer aandacht voor voeding in het onderwijs, in plaats van het verhogen van de belasting op essentiÃ«le levensbehoeften. "
      },
      {
        name: "Nieuwe Wegen",
        position: "contra",
  ...
  },
  {
    ...
    parties: [
      ...
      },
      {
        ...
        position: "pro",
        opinion:
          "Het individu staat bij ons voorop. Mensen die vinden dat hun leven is voltooid moeten hulp kunnen krijgen. Uiteraard moet er een duidelijk wettelijk kader worden gecreÃ«erd. "
      },
      {
        name: "Nieuwe Wegen",
        position: "pro",
      ...
      },
      {
        ...
        position: "pro",
        opinion:
          "Gezien de hogere levensverwachting, de toenemende eenzaamheid van ouderen en de problemen van langdurig zieke mensen, moeten ouderen die hun leven voltooid achten, recht krijgen op hulp bij het waardig beÃ«indigen van hun leven. Naast de al bestaande euthanasiewetgeving kunnen ouderen zonder overheidsbemoeienis zelf beschikken over hun levenseinde."
      },
      {
        name: "De Burger Beweging",
        position: "pro",
      ...
      },
      {
        ...
        position: "pro",
        opinion:
          "Iedereen die wilsbekwaam is moet zelf kunnen beslissen over zijn of haar eigen lot. Er dienen wel procedures opgesteld te worden zodat vrijwillige levensbeÃ«indiging in goede banen wordt geleid. Er mag *nooit* sprake zijn van enige (maatschappelijke) dwang in deze kwestie."
      },
      {
        name: "Lokaal in de Kamer",
        position: "pro",
      ...
      },
      {
        ...
        position: "none",
        opinion:
          "We willen de keuzevrijheid van het individu zo min mogelijk aantasten. Tegelijkertijd blijft het lastig om van de overheid te vragen om bij te dragen aan de wens om vrijwillige levensbeÃ«indiging bij voltooid leven."
      },
      {
        name: "Niet Stemmers",
        position: "none",
      ...
      },
      {
        ...
        position: "contra",
        opinion:
          "De ChristenUnie is fel tegen de plannen voor â€˜voltooid levenâ€™. Wij willen een samenleving waarin we omzien naar elkaar. Voor ons is elk leven beschermwaardig. We geloven in de kracht van goede zorg en aandacht voor ouderen, daar maken we werk van: www.waardigouderworden.nl "
      },
      {
        name: "SGP",
        position: "contra",
        opinion:
          "De SGP is tegen de plannen om de deur te openen voor hulp bij zelfdoding voor mensen die lijden 'aan het leven zelfâ€™. Het is de overtuiging van de SGP dat het leven van ieder mens als schepsel van God waardevol en kostbaar is. Ook wie dit christelijk uitgangspunt niet deelt, kan grote bezwaren inbrengen tegen de weg die het kabinet nu wil inslaan. Als het leven moeilijk wordt, moeten we medemensen niet prijsgeven aan de dood, maar met aandacht, liefde en goede zorg nabij zijn.\r\n"
      },
      {
        name: "DENK",
        position: "contra",
        opinion:
          "In plaats van mensen de ruimte te geven om hun leven te beÃ«indigen, wil DENK voorkomen dat mensen het gevoel hebben niet meer te willen leven. Daarom wil DENK stevig inzetten op het verbeteren van de ouderenzorg en een uitgebreid actieplan uitrollen om eenzaamheid te voorkomen.  "
      }
    ]
  },
  {
    ...
    parties: [
      ...
      },
      {
        ...
        position: "pro",
        opinion:
          "Het VERPLICHTE eigen risico moet worden afgeschaft. Afschaffing ervan verhoogt de premies met â‚¬284. Dit is nog altijd â‚¬101 minder dan het verplichte eigen risico. Hiernaast moet een vrijwillige eigen risico blijven bestaan.\r\n"
      },
      {
        name: "Lokaal in de Kamer",
        position: "pro",
      ...
      },
      {
        ...
        position: "none",
        opinion:
          "Artikel 1 vindt dat zorg toegankelijk moet zijn voor iedere Nederlander. Ook voor mensen met minder draagkracht en/of chronische gezondheidsproblemen. Het eigen risico afschaffen door de zorgpremie te verhogen is hiervoor geen oplossing.\r\n(blz. 14. Punt 1: Er komt een nationaal zorgfonds.)"
      },
      {
        name: "Niet Stemmers",
        position: "none",
      ...
      },
      {
        ...
        position: "contra",
        opinion:
          "Het eigen risico levert een belangrijke bijdrage aan de (hoge) zorgkosten. Afschaffen betekent dat premies met minimaal â‚¬284,- per jaar omhoog gaan. D66 wil liever diegene die de kosten lastig op kunnen brengen, bv. minima en/of chronisch zieken, tegemoetkomen via toeslagen."
      },
      {
        name: "ChristenUnie",
        position: "contra",
  ...
  },
  {
    ...
    parties: [
      ...
      },
      {
        ...
        position: "contra",
        opinion:
          "Een landelijk zorgfonds betekent terug naar het ziekenfonds: tweedeling, wachtlijsten, geen partijen die elkaar in balans houden. D66 investeert liever in de kwaliteit van de zorg en in innovatie. Zo stimuleren we dat zorgaanbieders, patiÃ«nten en verzekeraars samen de beste zorg leveren."
      },
      {
        name: "ChristenUnie",
        position: "contra",
        opinion:
          "De ChristenUnie wil minder marktwerking en meer zeggenschap. Er komt een maximale omvang voor zorgverzekeraars, met invloed van sterke ledenraden op het beleid. Zo kunnen zorgverzekeraars echt als coÃ¶peratie functioneren. Om verkeerde prikkels te vermijden moeten medisch specialisten in loondienst."
      },
      {
        name: "SGP",
        position: "contra",
      ...
      },
      {
        ...
        position: "contra",
        opinion:
          "DENK vindt het onverantwoord om het hele zorgstelsel op de schop te gooien. Dit leidt tot te grote onzekerheid voor patiÃ«nten en zorgverleners, omdat we niet weten wat de effecten en de kosten zijn. In plaats van deze onzekerheid, wil DENK de macht van de zorgverzekeraars in het huidige systeem aan banden leggen. DENK wil ook wat doen aan de grote en dure administratieve lasten en ervoor zorgen dat het geld niet naar de winstrekening van de farmaceutische industrie gaat, maar naar de patiÃ«nten."
      },
      {
        name: "Vrijzinnige Partij",
        position: "contra",
  ...
  },
  {
    ...
    parties: [
      ...
      },
      {
        ...
        position: "contra",
        opinion:
          "50PLUS is voor een nationaal leger, en tÃ©gen nog meer Europese integratie of delegatie van nationale bevoegdheden.. De Europese Unie heeft slechts drie kerntaken: economisch en monetair beleid, milieu- en energiebeleid en grensbeleid (veiligheid, defensie en buitenlands beleid). Samenwerken is goed en nodig, maar geen vorming van Ã©Ã©n leger."
      },
      {
        name: "OndernemersPartij",
        position: "contra",
  ...
  },
  {
    ...
    parties: [
      ...
      },
      {
        ...
        position: "pro",
        opinion:
          "Eens als het democratisch gehalte en het financiÃ«le beheer van de EU niet voldoende verbetert, het invoeren van een eerlijk geld en belastingsysteem en halveren van de bijdragen aan de EU met lid blijven van de EU niet mogelijk is."
      },
      {
        name: "Libertarische Partij",
        position: "pro",
      ...
      },
      {
        ...
        position: "contra",
        opinion:
          "De Piratenpartij is kritisch ten opzichte van het huidige functioneren van de EU. De EU moet transparanter, democratischer en efficiÃ«nter worden gemaakt. De beste manier om dit te bereiken is om dat van binnenuit te doen."
      },
      {
        name: "Artikel 1",
        position: "contra",
